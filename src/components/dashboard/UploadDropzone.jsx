  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-4 pt-2">
        <div className="w-[48px] h-[48px] rounded-full flex items-center justify-center bg-[#004AC6]/5">
          {icon === "upload" ? (
            <img src="/upload_icon.svg" alt="Upload" className="w-[21px] h-[15px]" />
          ) : (
            <img src="/plus_icon.svg" alt="Plus" className="w-[21px] h-[15px]" />
          )}
        </div>

        <div className="text-center flex flex-col gap-1">
          <p className="text-[16px] font-semibold text-gray-900 truncate max-w-[160px]">
            {file ? file.name : label}
          </p>
          <p className="text-[14px] font-normal text-[#434655]/70">
      ...
      <button
        ...
        className={`w-full py-2.5 rounded-xl text-[14px] font-semibold transition-all ${
          file
            ? "bg-white border border-[#C3C6D7] text-[#191C1E] hover:bg-white hover:border hover:border-gray-400"
